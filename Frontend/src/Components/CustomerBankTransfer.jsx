...
function CustomerBankTransfer() {
  ...
  const submitHandler = (values) => {
    ...
    axios
      .put(
        "http://localhost:9090/transaction/customer/transaction/bank-transfer",
        payload,
        {
          headers: {
  ...
  const validationSchema = Yup.object({
    accno: Yup.string().required("Account number required"),
                          ...
                          >
                            <Form className="user">
                              <div className="form-group text-left">
                                <label className="ps-3">Account Number</label>
                                <Field
                                ...
                                <ErrorMessage
                                  ...
                                  component={ErrorMsg}
                                />
                                <label className="ps-3">IFSC Code</label>
                                <Field
                                  className="form-control form-control-user mb-2"
                                  type="text"
                                  id="ifsccode"
                                  name="ifsccode"
                                  placeholder="Enter recipient's IFSC code"
                                />
                                <ErrorMessage
                                  name="ifsccode"
                                  component={ErrorMsg}
