...
function AdminRegisterVendor() {
  ...
  const onSubmit = (values) => {
    ...
    axios
      .post("http://localhost:9090/login/admin/register-vendor", payload, {
        headers: {
                            ...
                            <Form className="user">
                              <div className="form-group text-left">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label className="ps-3">Process</label>
                                    <Field
                                  ...
                                  <div className="col-sm-6">
                                    <label className="ps-3">Job Location</label>
                                    <Field
                                      className="form-control form-control-user mb-2"
                                      type="text"
                                      id="joblocation"
                                      name="joblocation"
                                      placeholder="Enter vendor's job location"
                                    />
                                    <ErrorMessage
                                      name="joblocation"
                                      component={ErrorMsg}
                                  ...
                                  <div className="col-sm-6">
                                    ...
                                    <Field
                                      ...
                                      placeholder="Enter vendor's password again"
                                    />
                                    <ErrorMessage
                                      name="verify_password"
                                      component={ErrorMsg}
...
export default AdminRegisterVendor;
