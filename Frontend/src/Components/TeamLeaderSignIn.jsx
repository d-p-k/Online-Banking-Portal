...
import teamleaderlogin from "../Components/img/teamleader_login.jpg";

export default function TeamLeaderSignIn() {
  const initialValues = {
    email: "",
    password: "",
  };
  ...
  const onLogin = (values) => {
    ...
    axios
      .post("http://localhost:9090/login/teamleader/authenticate", payload, {
        headers: {
      ...
      .then((res) => {
        ...
        if (res.data === "Invalid email or password") {
          ...
          nav("/teamleader-dashboard?showToast=true");
        }
      })
