...
function VendorDashboard() {
  ...
  useEffect(() => {
    ...
    const fetchHomeText = async () => {
      try {
        const response = await axios.get(
          "http://localhost:9090/login/vendor/home",
          {
            headers: {
    ...
    const fetchVendor = async () => {
      try {
        const response = await axios.get(
          "http://localhost:9090/login/vendor/profile",
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${auth.jwt}`,
  ...
  const changePassword = () => {
    ...
    console.log(payload);
    axios
      .post("http://localhost:9090/login/vendor/change-password", payload, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${auth.jwt}`,
        },
