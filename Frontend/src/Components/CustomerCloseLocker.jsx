...
function CustomerCloseLocker() {
  ...
  const submitHandler = (values) => {
    ...
    axios
      .put(
        "http://localhost:9090/locker/customer/locker/close-locker-request",
        payload,
        {
          headers: {
...
export default CustomerCloseLocker;
