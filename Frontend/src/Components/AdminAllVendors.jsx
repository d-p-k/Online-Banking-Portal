...
function AdminAllVendors() {
  ...
  const handleEdit = (vendor) => {
    setFormData({
      ...
      joblocation: vendor.joblocation,
    });
  };
  ...
  const fetchAllVendors = async () => {
    try {
      const response = await axios.get(
        "http://localhost:9090/login/admin/all-vendors",
        {
          headers: {
  ...
  const deleteVendor = (userid) => {
    ...
    console.log(payload);
    axios
      .put("http://localhost:9090/login/admin/delete-vendor", payload, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${auth.jwt}`,
        },
        ...
        <div id="content-wrapper" class="d-flex flex-column ">
          <div id="content">
            ...
            <div style={{ padding: "13px" }}>
              <p className="display-6 pb-1">All Vendors</p>
                  ...
                  <tbody>
                    {vendors.map((vendor, index) => (
                      <tr>
                        ...
                        <td>{vendor.process}</td>
                        <td>{vendor.joblocation}</td>
                        <td>
                          <button
                            type="submit"
      ...
      >
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body text-left">
              Select "Yes" below if you want to delete this vendor.
            </div>
            <div class="modal-footer">
              <button
                class="btn btn-secondary"
