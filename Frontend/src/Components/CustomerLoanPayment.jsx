...
function CustomerLoanPayment() {
  ...
  const submitHandler = (values) => {
    ...
    axios
      .put("http://localhost:9090/loan/customer/loan/loan-payment", payload, {
        headers: {
  ...
  const validationSchema = Yup.object({
    ...
    loanemi: Yup.number().positive().required("EMI is required."),
  });
        ...
        >
          ...
          <li className="nav-item">
            <Link className="nav-link" to="/customer-my-loans">
              <i class="bi bi-database-lock"></i> <span>My Loans</span>
            </Link>
          </li>
                            ...
                            <Form className="user">
                              <div className="form-group text-left">
                                ...
                                <ErrorMessage
                                  ...
                                  component={ErrorMsg}
                                />
                                <label className="ps-3">Loan EMI</label>
                                <Field
                                  className="form-control form-control-user mb-2"
                                  type="number"
                                  id="loanemi"
                                  name="loanemi"
                                  placeholder="Enter loan EMI"
                                />
                                <ErrorMessage
                                  name="loanamount"
                                  component={ErrorMsg}
...
export default CustomerLoanPayment;
