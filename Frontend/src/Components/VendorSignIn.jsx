...
import vendorlogin from "../Components/img/vendor_login.jpg";
...
export default function VendorSignIn() {
  ...
  const onLogin = (values) => {
    ...
    axios
      .post("http://localhost:9090/login/vendor/authenticate", payload, {
        headers: {
      ...
      .then((res) => {
        ...
        if (res.data === "Invalid email or password") {
          ...
          nav("/vendor-dashboard?showToast=true");
        }
      })
                  ...
                  <div className="col-lg-7">
                    <div className="p-5">
                      <div className="text-center">
                        <h1 className="h4 text-gray-900 mb-4">Vendor Login</h1>
                      </div>
                      <hr />
                      <Formik
