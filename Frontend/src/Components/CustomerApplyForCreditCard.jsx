...
function CustomerApplyForCreditCard() {
  ...
  const submitHandler = (values) => {
    ...
    axios
      .post(
        "http://localhost:9090/credit-card/customer/creditcard/apply-for-credit-card",
        payload,
        {
          headers: {
      ...
      .then((res) => {
        ...
        nav("/customer-apply-for-credit-card");
...
export default CustomerApplyForCreditCard;
